...
class Admin::OrdersControllerTest < ActionController::TestCase
  ...
  test "should create admin_order" do
    assert_difference('Admin::Order.count') do
      post :create, admin_order: { bid_or_ask: @admin_order.bid_or_ask, coin: @admin_order.coin, odr_date: @admin_order.odr_date, quantity: @admin_order.quantity, status: @admin_order.status }
    end
  ...
  test "should update admin_order" do
    patch :update, id: @admin_order, admin_order: { bid_or_ask: @admin_order.bid_or_ask, coin: @admin_order.coin, odr_date: @admin_order.odr_date, quantity: @admin_order.quantity, status: @admin_order.status }
    assert_redirected_to admin_order_path(assigns(:admin_order))
  end
